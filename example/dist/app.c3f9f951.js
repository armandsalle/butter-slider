...
var cursorTag = document.querySelector('.cursor');
var cursorX = 0;
var cursorY = 0;
...
var initCursor = function initCursor() {
  ...
  cursorTag.setAttribute('style', "top: ".concat(Math.round(positionCursorY), "px; left: ").concat(Math.round(positionCursorX), "px"));
...
var destroyBtn = document.querySelector('.js-destroy');
var initBtn = document.querySelector('.js-init');
var alertTag = document.querySelector('.js-alert');

var buttons = _toConsumableArray(document.querySelectorAll('button'));

var mySlider = new _slider.default('.slider', '.slides', {
  ...
  scrollPercent: function scrollPercent(e) {
    bar.style.width = "".concat(e, "%");
  },
  multiplicateur: 2,
  smoothAmount: 0.2
...
alertTag.addEventListener('click', function (e) {
  e.preventDefault();
  console.log('clicked');
});
},{"./cursor":"js/cursor.js","./slider":"js/slider.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
var OVERLAY_ID = '__parcel__error__overlay__';
var OldModule = module.bundle.Module;
